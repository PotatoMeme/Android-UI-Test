...
import com.potatomeme.jet_news.domain.entity.Metadata
import com.potatomeme.jet_news.domain.entity.Markup
import com.potatomeme.jet_news.domain.entity.MarkupType
import com.potatomeme.jet_news.domain.entity.Paragraph
import com.potatomeme.jet_news.domain.entity.ParagraphType
import com.potatomeme.jet_news.domain.entity.Post
import com.potatomeme.jet_news.domain.entity.PostAuthor
import com.potatomeme.jet_news.domain.entity.PostsFeed
import com.potatomeme.jet_news.domain.entity.Publication
...
class PostDataSource @Inject constructor() {
    ...
    val androidstudioteam = PostAuthor("Android Studio Team", "https://twitter.com/androidstudio")
    ...
    val paragraphsPost6 = listOf(
        Paragraph(
            ...
            ParagraphType.Header, "Identifying the problem"
        ), Paragraph(
            ParagraphType.Text,
            ...
            ParagraphType.Header, "A brief history of the Android Studio logo"
        ), Paragraph(
            ParagraphType.Bullet,
            ...
            ParagraphType.Header, "Understanding the Android brand elements"
        ), Paragraph(
            ParagraphType.Text,
            ...
            ParagraphType.Header, "Key objectives"
        ), Paragraph(
            ParagraphType.Bullet,
            ...
            ParagraphType.Text, "Read More", listOf(
                Markup(
                    MarkupType.Link,
                    0,
                    9,
    ...
    val post6 = Post(
        ...
        publication = publication,
        metadata = Metadata(
            author = androidstudioteam, date = "May 10", readTimeMinutes = 5
        ),
    ...
    val posts: PostsFeed = PostsFeed(
        ...
        recentPosts = listOf(
            post6, post3.copy(id = "post8"), post4.copy(id = "post9"), post5.copy(id = "post10")
        )
    )
