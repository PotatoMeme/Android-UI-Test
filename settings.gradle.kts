...
include(":screen:chirang-note-app:presentation-xml")
include(":screen:chirang-note-app:data")
include(":screen:chirang-note-app:domain")
include(":screen:clone-compose-codelabs:compose-basic")
include(":screen:clone-compose-codelabs:compose-basic-layout")
include(":screen:clone-compose-codelabs:compose-state")
include(":screen:clone-compose-codelabs:compose-theming")
